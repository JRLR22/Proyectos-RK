        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.books.update', $book->book_id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="author_name" 
                                   name="author_name" 
                                   value="{{ old('author_name', $book->authors->first()->name ?? '') }}" 
                                   required>
                            @error('author_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" 
                                   ...
                                   id="gonvill_code" 
                                   name="gonvill_code" 
                                   value="{{ old('gonvill_code', $book->gonvill_code) }}">
                            @error('gonvill_code')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            @endif
                            <label for="cover_image" class="form-label">{{ $book->cover_image ? 'Cambiar Imagen' : 'Agregar Imagen' }}</label>
                            <input type="file" 
