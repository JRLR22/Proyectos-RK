    ...
    <div class="space-y-3">
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">GUADALAJARA, JAL.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">PUERTO VALLARTA, JAL.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">CHIHUAHUA, CHIH.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">MAZATLÁN, SIN.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">CULIACÁN, SIN.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">CDMX / OFICINA (NOTA: VENTA EXCLUSIVA MAYOREO).</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">MONTERREY, N.L.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">LEÓN, GTO.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">SAN LUIS POTOSÍ, S.L.P.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">TORREÓN, COAH.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">QUERÉTARO, QRO.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
        ...
        <details class="border border-gray-200 rounded-lg overflow-hidden">
            <summary class="flex justify-between items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors">
                <span class="text-[#00A6CE] font-semibold">AGUASCALIENTES, AGS.</span>
                <span class="text-[#00A6CE] text-2xl">+</span>
            </summary>
            <div class="p-4 bg-gray-50 border-t border-gray-200">
                <p class="text-gray-700">Información de sucursal disponible próximamente.</p>
